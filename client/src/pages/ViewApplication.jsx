		...
		<div className="container">
			<div className="view-application">
				...
				<div className="application-container">
					...
					<p><strong>Job Alerts:</strong> {formData.jobAlerts ? "Yes" : "No"}</p>
					<p><strong>Home Phone:</strong> {formData.homePhone}</p>
					<p><strong>Additional Home Phone:</strong> {formData.addHomePhone}</p>
					...
					<p><strong>Yes/No Question:</strong> {formData.yesNoQuestion}</p>
					<p><strong>Two Wheeler:</strong> {formData.twoWheeler ? "Yes" : "No"}</p>
					<p><strong>Three Wheeler:</strong> {formData.threeWheeler ? "Yes" : "No"}</p>
					<p><strong>Car:</strong> {formData.car ? "Yes" : "No"}</p>
					<p>
